class ApplicationController < ActionController::Base
  ...
  def verify_user_is_ready!
  	...
  	redirect_to signup_add_payment_url and return unless current_user.ready?
  end

  def no_user!
    redirect_to signup_add_payment_url and return if current_user and not current_user.ready?
