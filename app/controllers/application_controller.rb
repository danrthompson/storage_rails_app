class ApplicationController < ActionController::Base
  ...
  def verify_user_is_ready!
  	...
  	redirect_to signup_select_items_url(current_user.id) and return unless current_user.ready?
  end

  def no_user!
    redirect_to signup_select_items_url(current_user.id) and return if current_user and not current_user.ready?
